"""Lightweight MambaTransDTA-style SMILES encoder.

This is an engineering baseline interface. Once the official code is available,
the block details should be aligned more tightly with MambaTransDTA.
"""
